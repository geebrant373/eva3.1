...
public class S_BoardReadAdena extends ServerBasePacket {

	private static final String S_BoardRead = "[C] S_BoardRead";

	private static Logger _log = Logger.getLogger(S_BoardReadAdena.class.getName());

	private byte[] _byte = null;

	public S_BoardReadAdena(int number) {
		buildPacket(number);
	}
