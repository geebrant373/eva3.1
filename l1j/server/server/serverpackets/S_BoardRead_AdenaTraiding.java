...
public class S_BoardRead_AdenaTraiding extends ServerBasePacket {

	private static final String S_BoardRead_ServerInfo = "[C] S_BoardRead_ServerInfo";

	private static Logger _log = Logger.getLogger(S_BoardRead_AdenaTraiding.class.getName());

	private byte[] _byte = null;

	public S_BoardRead_AdenaTraiding(int number) {
		buildPacket(number);
	}
