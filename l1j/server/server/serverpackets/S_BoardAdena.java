...
public class S_BoardAdena extends ServerBasePacket {

	private static final String S_BOARD = "[S] S_Board";

	private static Logger _log = Logger.getLogger(S_BoardAdena.class.getName());

	private byte[] _byte = null;

	public S_BoardAdena(L1NpcInstance board) {
		buildPacket(board, 0);
	}

	public S_BoardAdena(L1NpcInstance board, int number) {
