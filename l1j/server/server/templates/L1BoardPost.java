...
public class L1BoardPost {
	...
	public synchronized static L1BoardPost createGM사냥터정보(String name, String title, String content) {
		Connection con = null;
		PreparedStatement pstm1 = null;
		ResultSet rs = null;
		PreparedStatement pstm2 = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm1 = con.prepareStatement("SELECT max(id) + 1 as newid FROM board_사냥터정보");
			rs = pstm1.executeQuery();
			rs.next();
			int id = rs.getInt("newid");
			L1BoardPost topic = new L1BoardPost(id, name, title, content);
			pstm2 = con.prepareStatement("INSERT INTO board_사냥터정보 SET id=?, name=?, date=?, title=?, content=?");
			pstm2.setInt(1, topic.getId());
			pstm2.setString(2, topic.getName());
			pstm2.setString(3, topic.getDate());
			pstm2.setString(4, topic.getTitle());
	...
	public synchronized static L1BoardPost createGM보스정보(String name, String title, String content) {
		Connection con = null;
		PreparedStatement pstm1 = null;
		ResultSet rs = null;
		PreparedStatement pstm2 = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm1 = con.prepareStatement("SELECT max(id) + 1 as newid FROM board_보스정보");
			rs = pstm1.executeQuery();
			rs.next();
			int id = rs.getInt("newid");
			L1BoardPost topic = new L1BoardPost(id, name, title, content);
			pstm2 = con.prepareStatement("INSERT INTO board_보스정보 SET id=?, name=?, date=?, title=?, content=?");
			pstm2.setInt(1, topic.getId());
			pstm2.setString(2, topic.getName());
			pstm2.setString(3, topic.getDate());
			pstm2.setString(4, topic.getTitle());
	...
	public synchronized static L1BoardPost createGM무기정보(String name, String title, String content) {
		Connection con = null;
		PreparedStatement pstm1 = null;
		ResultSet rs = null;
		PreparedStatement pstm2 = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm1 = con.prepareStatement("SELECT max(id) + 1 as newid FROM board_무기정보");
			rs = pstm1.executeQuery();
			rs.next();
			int id = rs.getInt("newid");
			L1BoardPost topic = new L1BoardPost(id, name, title, content);
			pstm2 = con.prepareStatement("INSERT INTO board_무기정보 SET id=?, name=?, date=?, title=?, content=?");
			pstm2.setInt(1, topic.getId());
			pstm2.setString(2, topic.getName());
			pstm2.setString(3, topic.getDate());
			pstm2.setString(4, topic.getTitle());
	...
	public synchronized static L1BoardPost createGM방어구정보(String name, String title, String content) {
		Connection con = null;
		PreparedStatement pstm1 = null;
		ResultSet rs = null;
		PreparedStatement pstm2 = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm1 = con.prepareStatement("SELECT max(id) + 1 as newid FROM board_방어구정보");
			rs = pstm1.executeQuery();
			rs.next();
			int id = rs.getInt("newid");
			L1BoardPost topic = new L1BoardPost(id, name, title, content);
			pstm2 = con.prepareStatement("INSERT INTO board_방어구정보 SET id=?, name=?, date=?, title=?, content=?");
			pstm2.setInt(1, topic.getId());
			pstm2.setString(2, topic.getName());
			pstm2.setString(3, topic.getDate());
			pstm2.setString(4, topic.getTitle());
	...
	public synchronized static L1BoardPost createGM인첸율정보(String name, String title, String content) {
		Connection con = null;
		PreparedStatement pstm1 = null;
		ResultSet rs = null;
		PreparedStatement pstm2 = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm1 = con.prepareStatement("SELECT max(id) + 1 as newid FROM board_인첸율정보");
			rs = pstm1.executeQuery();
			rs.next();
			int id = rs.getInt("newid");
			L1BoardPost topic = new L1BoardPost(id, name, title, content);
			pstm2 = con.prepareStatement("INSERT INTO board_인첸율정보 SET id=?, name=?, date=?, title=?, content=?");
			pstm2.setInt(1, topic.getId());
			pstm2.setString(2, topic.getName());
			pstm2.setString(3, topic.getDate());
			pstm2.setString(4, topic.getTitle());
	...
	private static PreparedStatement makeIndexStatementGM사냥터정보(Connection con, int id,int limit) throws SQLException {
		PreparedStatement result = null;
		int offset = 1;
		if (id == 0) {
			result = con.prepareStatement("SELECT * FROM board_사냥터정보 ORDER BY id DESC LIMIT ?");
		} else {
			result = con.prepareStatement("SELECT * FROM board_사냥터정보 WHERE id < ? ORDER BY id DESC LIMIT ?");
			result.setInt(1, id);
			offset++;
		}
		result.setInt(offset, limit);
	...
	private static PreparedStatement makeIndexStatementGM보스정보(Connection con, int id,int limit) throws SQLException {
		PreparedStatement result = null;
		int offset = 1;
		if (id == 0) {
			result = con.prepareStatement("SELECT * FROM board_보스정보 ORDER BY id DESC LIMIT ?");
		} else {
			result = con.prepareStatement("SELECT * FROM board_보스정보 WHERE id < ? ORDER BY id DESC LIMIT ?");
			result.setInt(1, id);
			offset++;
		}
		result.setInt(offset, limit);
	...
	private static PreparedStatement makeIndexStatementGM무기정보(Connection con, int id,int limit) throws SQLException {
		PreparedStatement result = null;
		int offset = 1;
		if (id == 0) {
			result = con.prepareStatement("SELECT * FROM board_무기정보 ORDER BY id DESC LIMIT ?");
		} else {
			result = con.prepareStatement("SELECT * FROM board_무기정보 WHERE id < ? ORDER BY id DESC LIMIT ?");
			result.setInt(1, id);
			offset++;
		}
		result.setInt(offset, limit);
	...
	private static PreparedStatement makeIndexStatementGM방어구정보(Connection con, int id,int limit) throws SQLException {
		PreparedStatement result = null;
		int offset = 1;
		if (id == 0) {
			result = con.prepareStatement("SELECT * FROM board_방어구정보 ORDER BY id DESC LIMIT ?");
		} else {
			result = con.prepareStatement("SELECT * FROM board_방어구정보 WHERE id < ? ORDER BY id DESC LIMIT ?");
			result.setInt(1, id);
			offset++;
		}
		result.setInt(offset, limit);
	...
	private static PreparedStatement makeIndexStatementGM인첸율정보(Connection con, int id,int limit) throws SQLException {
		PreparedStatement result = null;
		int offset = 1;
		if (id == 0) {
			result = con.prepareStatement("SELECT * FROM board_인첸율정보 ORDER BY id DESC LIMIT ?");
		} else {
			result = con.prepareStatement("SELECT * FROM board_인첸율정보 WHERE id < ? ORDER BY id DESC LIMIT ?");
			result.setInt(1, id);
			offset++;
		}
		result.setInt(offset, limit);
	...
	public static List<L1BoardPost> indexGM사냥터정보(int id, int limit) {
		List<L1BoardPost> result = new ArrayList<L1BoardPost>();
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm = makeIndexStatementGM사냥터정보(con, id, limit);
			rs = pstm.executeQuery();
			while (rs.next()) {
				result.add(new L1BoardPost(rs));
			}
	...
	public static List<L1BoardPost> indexGM보스정보(int id, int limit) {
		List<L1BoardPost> result = new ArrayList<L1BoardPost>();
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm = makeIndexStatementGM보스정보(con, id, limit);
			rs = pstm.executeQuery();
			while (rs.next()) {
				result.add(new L1BoardPost(rs));
			}
	...
	public static List<L1BoardPost> indexGM무기정보(int id, int limit) {
		List<L1BoardPost> result = new ArrayList<L1BoardPost>();
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm = makeIndexStatementGM무기정보(con, id, limit);
			rs = pstm.executeQuery();
			while (rs.next()) {
				result.add(new L1BoardPost(rs));
			}
	...
	public static List<L1BoardPost> indexGM방어구정보(int id, int limit) {
		List<L1BoardPost> result = new ArrayList<L1BoardPost>();
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm = makeIndexStatementGM방어구정보(con, id, limit);
			rs = pstm.executeQuery();
			while (rs.next()) {
				result.add(new L1BoardPost(rs));
			}
	...
	public static List<L1BoardPost> indexGM인첸율정보(int id, int limit) {
		List<L1BoardPost> result = new ArrayList<L1BoardPost>();
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm = makeIndexStatementGM인첸율정보(con, id, limit);
			rs = pstm.executeQuery();
			while (rs.next()) {
				result.add(new L1BoardPost(rs));
			}
