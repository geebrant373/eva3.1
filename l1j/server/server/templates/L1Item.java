...
public abstract class L1Item implements Serializable {
	...
	private int _limit_time = 0;
	public int getLimitTime() {	return _limit_time;	}
	public void setLimitTime(int i) {	_limit_time = i;	}
	...
	private int _Hitup_magic;
	public int getHitup_magic() {
		return _Hitup_magic;
	}
	public void setHitup_magic(int i) {
		_Hitup_magic = i;
	}
	/*
