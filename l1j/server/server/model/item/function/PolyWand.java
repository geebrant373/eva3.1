...
public class PolyWand extends L1ItemInstance{
	...
	public void clickItem(L1Character cha, ClientBasePacket packet){
		if(cha instanceof L1PcInstance){
			...
			if (pc.getMapId() == 5153 ) {
				pc.sendPackets(new S_SystemMessage("배틀존에서는 변신 관련 아이템을 사용할 수 없습니다."));
				return;
			}
	...
	public static void polyAction(L1PcInstance attacker, L1Character cha) {
