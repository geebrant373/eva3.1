...
public class HealingPotion extends L1ItemInstance{
	...
	public void clickItem(L1Character cha, ClientBasePacket packet){
		if(cha instanceof L1PcInstance){
			...
			case 40019://주
			case 40029://?
				UseHeallingPotion(pc, Config.빨갱이회복량, 189);
				break;
			case 40011: //농빨
			case 40020: //농주
				UseHeallingPotion(pc, Config.주홍이회복량, 194);
				break;
			case 40012://말
			case 40021:
			case 435000:
				UseHeallingPotion(pc, Config.맑갱이회복량, 197);
				break;
			case 40022:
			case 41141:
			...
			if (pc.isAutoPotion()) {
				...
				pc.setHealItemNum(0);
				pc.setHealVal(0);
				pc.sendPackets(new S_SystemMessage("수동 물약 사용으로 인해 자동물약을 종료합니다."));
			}
