...
public class L1Party {
	...
	public L1PcInstance[] getVisiblePartyMembers(L1PcInstance pc) {
        List<L1PcInstance> partyMembers = _membersList;
        ...
        return visibleList.toArray(new L1PcInstance[visibleList.size()]);
    }
