...
public class L1Spawn {
	...
	public String getMent() {	return _ment;	}
	public void setMent(String ment) {	_ment = ment;	}
	...
	protected void doSpawn(int spawnNumber, int objectId) {
		...
		try {
			...
			while (tryCount <= 50) {
				...
				if (isAreaSpawn()) {
					if ((this._spawnHomePoint) && (null != (pt = this._homePoint.get(Integer.valueOf(spawnNumber))))) {
			...
			if (getMent() != "") {
				L1World.getInstance().broadcastPacketToAll(
						new S_PacketBox(S_PacketBox.GREEN_MESSAGE, getMent()));
				L1World.getInstance().broadcastPacketToAll(
