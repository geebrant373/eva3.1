...
public class L1ItemInstance extends L1Object {
	...
	public int getMr() {
		...
		if (itemid == 20011 || itemid == 20110 || itemid == 120011 || itemid == 420108 || itemid == 420109 || itemid == 420110
				|| itemid == 420111 || itemid == 425108 || itemid == 2020011) {
			mr += getEnchantLevel();
		}
		...
		if (itemid == 20078 || itemid == 20079 || itemid == 20402 || itemid == 222325 || itemid == 2222325) {// 진명망토 인챈*3mr상승 0221
	...
	public byte[] getStatusBytes() {
		...
		if (itemType2 == 0) { // etcitem
			...
			if (getItem().getType() == 10) {
				...
				if (getItem().get_safeenchant() == 4) {
					if (itemId == 222324 || itemId == 222325 || itemId == 222328 || itemId == 222329 || itemId == 21122 
							|| itemId == 20049 || itemId == 20050 || itemId == 2222324 || itemId == 2222325) {
						switch(getEnchantLevel()) {
						case 7:
							os.writeC(39);
							os.writeS("대미지 감소 +" + (getItem().getDamageReduction() + 2));
					...
					if (itemId == 222326 || itemId == 222327 || itemId == 222328 || itemId == 20464 || itemId == 20017 || itemId == 20079 || itemId == 222317 || itemId == 2222326 || itemId == 2222327) {
						switch(getEnchantLevel()) {
						case 8:
							os.writeC(39);
							os.writeS("대미지 감소 +" + (getItem().getDamageReduction() + 2));
			...
			if ((getItem().getType() >= 8 && getItem().getType() <= 9
				...
				if (getItem().get_safeenchant() == 4) {
					if (itemId == 222324 || itemId == 222325 || itemId == 222328 || itemId == 222329 || itemId == 21122 || itemId == 20049 || itemId == 20050 || itemId == 2222324 || itemId == 2222325) {
						switch(getEnchantLevel()) {
						case 7:
							os.writeC(14);
							os.writeH(getItem().get_addhp() + 10);
					...
					if (itemId == 222326 || itemId == 222327 || itemId == 222328 || itemId == 20079 || itemId == 222317 || itemId == 2222326 || itemId == 2222327) {
						switch(getEnchantLevel()) {
						case 8:
							os.writeC(14);
							os.writeH(getItem().get_addhp() + 10);
			...
			} else if ((itemId >= 23100 && itemId <= 23103 || itemId >= 2023100 && itemId <= 2023102)&& getEnchantLevel() >= 3) {
				switch (getEnchantLevel()) {
				case 3 :
					os.writeC(15);
					os.writeH(getMr() + 3);
			...
			if (get_bless_level() != 0) {
				if (getItem().getItemId() == 9 || getItem().getItemId() == 190 || getItem().getItemId() == 317 || getItem().getItemId() == 127 ||
					...
					getItem().getItemId() == 180 || getItem().getItemId() == 57 || getItem().getItemId() == 162 || getItem().getItemId() == 126
