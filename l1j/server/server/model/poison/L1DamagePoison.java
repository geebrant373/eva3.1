...
public class L1DamagePoison extends L1Poison {
	...
	private class NormalPoisonTimer extends Thread {
		...
		public void run() {
			...
			if (_target instanceof L1PcInstance) {
				...
				.sendPackets(new S_SkillSound(_target.getId(), L1SkillId.STR_STATUS_EFFECT_TAIWAN_STONE_BUFF12));
			}
		}
	}
	...
	private void doInfection() {
		...
		if (_target instanceof L1PcInstance) {
			((L1PcInstance) _target)
					.sendPackets(new S_SkillSound(_target.getId(), L1SkillId.STR_STATUS_EFFECT_TAIWAN_STONE_BUFF11));
		}
