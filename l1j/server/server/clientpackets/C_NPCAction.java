...
import l1j.server.server.serverpackets.S_SearchAdenaTrade2;
...
public class C_NPCAction extends ClientBasePacket {
	...
	public C_NPCAction(byte abyte0[], LineageClient client) throws Exception {
		...
		if (UserCommands.checkAutohunt(pc, s)) {
			return;
		}

		if (UserCommands.abc(pc, s)) {
			return;
		}
		
		if (UserCommands.checkCraftOneDoll(pc, s)) {
            return; 
        }

		if (UserCommands.checkCraftTwoDoll(pc, s)) {
            return; 
        }
		
		if (UserCommands.checkCraftThreeDoll(pc, s)) {
            return; 
        }
		
		if (UserCommands.checkCraftFourDoll(pc, s)) {
            return; 
        }
		
		if (pc.getId() == objid) {
			if (s.equalsIgnoreCase("tradesell1")) {
				pc.sendPackets(new S_SearchAdenaTrade2(pc, 0, pc.trade_ids[0]));
				return;
			} else if (s.equalsIgnoreCase("tradesell2")) {
				pc.sendPackets(new S_SearchAdenaTrade2(pc, 0, pc.trade_ids[1]));
				return;
			} else if (s.equalsIgnoreCase("tradesell3")) {
				pc.sendPackets(new S_SearchAdenaTrade2(pc, 0, pc.trade_ids[2]));
				return;
			} else if (s.equalsIgnoreCase("tradesell4")) {
				pc.sendPackets(new S_SearchAdenaTrade2(pc, 0, pc.trade_ids[3]));
				return;
			} else if (s.equalsIgnoreCase("tradesell5")) {
				pc.sendPackets(new S_SearchAdenaTrade2(pc, 0, pc.trade_ids[4]));
				return;
			} else if (s.equalsIgnoreCase("tradebuy1")) {
				pc.sendPackets(new S_SearchAdenaTrade2(pc, 1, pc.trade_ids[5]));
				return;
			}
		}
		
		if (s.equalsIgnoreCase("sell1")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
				}
			}

			if (pc.SellPriclist.size() != 0) {
				L1PriceTemp temp = pc.SellPriclist.get(0);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
						SearchShopHtmlTimer timer = new SearchShopHtmlTimer(pc, target1);
						timer.begin();
					} else {
						L1ShopNpcInstance shop = L1World.getInstance().getShopNpc(temp.pcname);
						if (shop != null) {
							SearchShopHtmlTimer timer = new SearchShopHtmlTimer(pc, shop);
							timer.begin();
						}
					}
				}
			...
			return;
		} else if (s.equalsIgnoreCase("sell2")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.SellPriclist.size() != 0) {
				L1PriceTemp temp = pc.SellPriclist.get(1);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("sell3")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.SellPriclist.size() != 0) {
				L1PriceTemp temp = pc.SellPriclist.get(2);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("sell4")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.SellPriclist.size() != 0) {
				L1PriceTemp temp = pc.SellPriclist.get(3);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("sell5")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.SellPriclist.size() != 0) {
				L1PriceTemp temp = pc.SellPriclist.get(4);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("buy1")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.BuyPriclist.size() != 0) {
				L1PriceTemp temp = pc.BuyPriclist.get(0);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("buy2")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.BuyPriclist.size() != 0) {
				L1PriceTemp temp = pc.BuyPriclist.get(1);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("buy3")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.BuyPriclist.size() != 0) {
				L1PriceTemp temp = pc.BuyPriclist.get(2);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("buy4")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.BuyPriclist.size() != 0) {
				L1PriceTemp temp = pc.BuyPriclist.get(3);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("buy5")) {
			if (pc.getMapId() != 340) {
				if (!(pc.getX() >= 33309 && pc.getX() <= 33561) && (pc.getY() >= 32629 && pc.getY() <= 32900)) {
					pc.sendPackets(new S_SystemMessage("시장과 기란 마을에서 사용 할 수 있습니다."));
					return;
			...
			if (pc.BuyPriclist.size() != 0) {
				L1PriceTemp temp = pc.BuyPriclist.get(4);
				if (temp != null) {
					L1Teleport.teleport(pc, temp.locX, temp.locY, (short) temp.mapid, 5, true);
					L1PcInstance target1 = L1World.getInstance().getPlayer(temp.pcname);
					if (target1 != null) {
			...
			return;
		} else if (s.equalsIgnoreCase("eternal_metice_buff")) {
			int[] allBuffSkill = Config.Metice_Buff;
		...
		if (obj != null) {
			if (obj instanceof L1NpcInstance) {
				...
				if (target.getInventory().checkItem(52064) && useOmanTeleportBook(target, 52064, s)) {
				}
				if (target.getInventory().checkItem(52063) && useJoeTeleportBook1(target, 52063, s)) {
				} else if (target.getInventory().checkItem(45109) && useJinPolyList(target, 45109, s)) {
				} else if (target.getInventory().checkItem(430634) && useJinPolyList1(target, 430634, s)) {
				} else if (target.getInventory().checkItem(52065) && useJoeTeleportBook(target, 52065, s)) {
				} else if (target.getInventory().checkItem(45073) && useBossTeleportBook(target, 45073, s)) {
				} else if (target.getInventory().checkItem(45072) && useBeginnerTeleportBook(target, 45072, s)) {
				}
				...
				if (EventInfo.get_npc_id() == npc.getNpcId()) {
					if (s.equalsIgnoreCase(EventInfo.get_action_name())) {
						if (EventInfo.is_event()) {
							...
							pc.sendPackets(new S_SystemMessage("현재 이벤트가 진행중이지 않습니다."));
							return;
						}
					}
				}
		...
		if (s.startsWith("제작시작")) {
			if (pc.Craft_Npcid == 0 || pc.Craft_Orderid == -1) {
				pc.sendPackets(new S_SystemMessage("오류입니다. 다시 시도해주세요."));
				return;
			}

			CraftTemp temp = CraftListTable.getInstance().getCraftTemp(pc.Craft_Npcid, pc.Craft_Orderid);
			if (temp == null) {
				pc.sendPackets(new S_SystemMessage("제작 리스트 오류입니다. 운영자에게 문의해주세요."));
				return;
			}
			 ...
			 * 재료 확인부분
			 */
			boolean isMeterial = true;
			boolean isSuccess = false;
			for (CraftMeterialTemp mtemp : temp._MeterialList) {
				L1Item tempitem = ItemTable.getInstance().getTemplate(mtemp.itemid);
				L1ItemInstance item = ItemTable.getInstance().FunctionItem(tempitem);
				
				int successRate = temp.create_chance;
				...
				if (item == null) {
					pc.sendPackets(new S_SystemMessage("재료번호:" + mtemp.itemid + "은 존재하지 않는 아이템입니다."));
					return;
				}
				...
				// 겹치는 아이템
				if (item.isStackable()) {
					L1ItemInstance meter_item = pc.getInventory().findItemIdBless(mtemp.itemid, mtemp.bless);
					if (meter_item == null) {
						pc.sendPackets(new S_SystemMessage("[" + itemName + "] " + mtemp.count + "개 부족합니다."));
						isMeterial = false;
					} else {
						if (mtemp.count > meter_item.getCount()) {
							int consumeCount = mtemp.count - meter_item.getCount();
							pc.sendPackets(new S_SystemMessage("[" + itemName + "] " + consumeCount + "개 부족합니다."));
							isMeterial = false;
						}
					}
				} else {
					L1ItemInstance[] items = pc.getInventory().findItemsIdNotEquippedCraftBless(mtemp.itemid,
							mtemp.enchant, mtemp.bless);
					if (items.length == 0) {
						pc.sendPackets(new S_SystemMessage("[" + itemName + "] " + mtemp.count + "개 부족합니다."));
						isMeterial = false;
					} else if (mtemp.count > items.length) {
						int consumeCount = mtemp.count - items.length;
						pc.sendPackets(new S_SystemMessage("[" + itemName + "] " + consumeCount + "개 부족합니다."));
						isMeterial = false;
					}
				}
			 ...
			 */
			for (CraftMeterialTemp mtemp : temp._MeterialList) {
				L1Item item = ItemTable.getInstance().getTemplate(mtemp.itemid);
				if (item == null) {
					pc.sendPackets(new S_SystemMessage("재료번호:" + mtemp.itemid + "은 존재하지 않는 아이템입니다."));
					return;
				}
				...
				if (item.isStackable()) {
					L1ItemInstance meter_item = pc.getInventory().findItemIdBless(mtemp.itemid, mtemp.bless);
					pc.getInventory().removeItem(meter_item, mtemp.count);
				} else {
					L1ItemInstance[] items = pc.getInventory().findItemsIdNotEquippedCraftBless(mtemp.itemid,
							mtemp.enchant, mtemp.bless);
					for (int i = 0; i < mtemp.count; i++) {
						pc.getInventory().removeItem(items[i], 1);
					}
					if (!isSuccess) {
						if (item.getItemId() >= 40289 && item.getItemId() <= 40298) {
							pc.getInventory().storeItem(item.getItemId(), 1);
						}
					}
				}
			}
			...
			if (!isSuccess) {
				pc.sendPackets(new S_SystemMessage("제작에 실패하였습니다."));
				return;
			}
			/*
			 * 아이템 생성
			 */
			L1Item tempitem = ItemTable.getInstance().getTemplate(temp.create_id);
			if (tempitem.isStackable()) {
				L1ItemInstance craftitem = pc.getInventory().storeItem(temp.create_id, temp.create_count);
				craftitem.setIdentified(true);
				craftitem.setBless(temp.create_bless);
				pc.getInventory().updateItem(craftitem, L1PcInventory.COL_BLESS);
				pc.getInventory().saveItem(craftitem, L1PcInventory.COL_BLESS);
				pc.sendPackets(new S_ItemStatus(craftitem));
				...
				itemName += craftitem.getName();

				pc.sendPackets(new S_SystemMessage(itemName + "(" + temp.create_count + ") 제작하였습니다."));
				return;
			} else {
				if (temp.create_count > 1) {
					L1ItemInstance craftitem = null;
					for (int i = 0; i < temp.create_count; i++) {
						craftitem = pc.getInventory().storeItem(temp.create_id, 1, temp.create_enchant);
						craftitem.setBless(temp.create_bless);
						pc.getInventory().updateItem(craftitem, L1PcInventory.COL_BLESS);
						pc.getInventory().saveItem(craftitem, L1PcInventory.COL_BLESS);
						craftitem.setIdentified(true);
						pc.getInventory().updateItem(craftitem, L1PcInventory.COL_IS_ID);
					}
					...
					if (temp.create_id == 90000011) {
						int randomsel1 = _random.nextInt(5);
						int doll1[] = {430000,430002,430003,430004,430505}; // 2단계
						temp.create_id = doll1[randomsel1];
					} else if (temp.create_id == 90000012) {
						int randomsel1 = _random.nextInt(5);
						int doll1[] = {4370599,4370600,744,743,447016}; // 3단계
						temp.create_id = doll1[randomsel1];
					} else if (temp.create_id == 90000013) {
						int randomsel1 = _random.nextInt(5);
						int doll1[] = {5370600,5370601,5370602,5370603,5370604}; // 4단계
						temp.create_id = doll1[randomsel1];
					} else if (temp.create_id == 90000014) {
						int randomsel1 = _random.nextInt(4);
						int doll1[] = {5370605,5370606,5370607,5370608}; // 5단계
						temp.create_id = doll1[randomsel1];
					}
					L1ItemInstance craftitem = pc.getInventory().storeItem(temp.create_id, 1, temp.create_enchant);
					craftitem.setBless(temp.create_bless);
					pc.getInventory().updateItem(craftitem, L1PcInventory.COL_BLESS);
					pc.getInventory().saveItem(craftitem, L1PcInventory.COL_BLESS);
					craftitem.setIdentified(true);
					...
					pc.sendPackets(new S_SystemMessage(itemName + "(" + temp.create_count + ") 제작하였습니다."));
					if (temp.create_id == 430000 || temp.create_id == 430002 || temp.create_id == 430003 || temp.create_id == 430004 || temp.create_id == 430505) {
						temp.create_id = 90000011;
					}
					if (temp.create_id == 4370599 || temp.create_id == 4370600 || temp.create_id == 744 || temp.create_id == 743 || temp.create_id == 447016) {
						temp.create_id = 90000012;
					}
					if (temp.create_id == 5370600 || temp.create_id == 5370601 || temp.create_id == 5370602 || temp.create_id == 5370603 || temp.create_id == 5370604) {
						temp.create_id = 90000013;
					}
					if (temp.create_id == 5370605 || temp.create_id == 5370606 || temp.create_id == 5370607 || temp.create_id == 5370608) {
						temp.create_id = 90000014;
					}
					return;
				}
			}
		} else if (s.startsWith("제작")) {
			if (obj != null && obj instanceof L1NpcInstance) {
				L1NpcInstance npc = (L1NpcInstance) obj;
				String orders = s.replace("제작", "");
				int npcid = ((L1NpcInstance) obj).getNpcId();
				int orderid = Integer.parseInt(orders);

				pc.Craft_Npcid = npcid;
				pc.Craft_Orderid = orderid;

				pc.sendPackets(new S_CraftItem(pc, npc.getId()));
			}
			return;
		}
		if (s.startsWith("tel_")) {
			if (pc.isSleeped() || pc.isParalyzed() || pc.getSkillEffectTimerSet().hasSkillEffect(87)
					|| pc.getSkillEffectTimerSet().hasSkillEffect(157) || pc.getSkillEffectTimerSet().hasSkillEffect(50)
					|| pc.getSkillEffectTimerSet().hasSkillEffect(80)
					|| pc.getSkillEffectTimerSet().hasSkillEffect(1009)
					|| pc.getSkillEffectTimerSet().hasSkillEffect(2504)
					|| pc.getSkillEffectTimerSet().hasSkillEffect(2506)) {
			...
			StringTokenizer t = new StringTokenizer(s, "tel_");
			String nametemp = t.nextToken();
			int tel_id = Integer.parseInt(nametemp);
			huntingbookTable.telTemp hunting = huntingbookTable.getInstance().getHuntingTemp(tel_id);
			if (hunting == null) {
				pc.sendPackets((ServerBasePacket) new S_SystemMessage("사냥터 기억책의 정보가 존재 하지 않습니다. 운영자에게 문의해주세요."));
				return;
			}
			if (hunting.isWanted && pc.getWanted() == 0) {
				pc.sendPackets((ServerBasePacket) new S_SystemMessage("해당 사냥터는 수배를 해야만 갈 수 있습니다."));
				return;
			}
			if (pc.getMap().isEscapable() || pc.isGm()) {
				if (pc.getInventory().checkItem(50118, 1)) {
					pc.getInventory().consumeItem(50118, 1);
					L1Teleport.teleport(pc, hunting.locX, hunting.locY, (short) hunting.mapid, 5, true);
					pc.getSkillEffectTimerSet().setSkillEffect(78, 3000);
					return;
				}
				pc.sendPackets((ServerBasePacket) new S_SystemMessage("사냥터 이동 기억책이 부족 합니다."));
				return;
			}
		...
		if (s.equalsIgnoreCase("buy")) {
			...
			if (npcid == 4220000 || npcid == 4220001 || npcid == 4220002 || npcid == 4220003 || npcid == 4220700
					|| npcid == 4200104 || npcid == 46198 || npcid == 146198 || npcid == 46200 || npcid == 900001619) {
				pc.sendPackets(new S_PremiumShopSellList(objid));
				return;
			}
			if (npcid == 70068 || npcid == 70020 || npcid == 70056 || npcid == 70051 || npcid == 70055
			...
			if (s.equalsIgnoreCase("room")) {
				...
				if (pc.getInventory().checkItem(40312)) {
					if (map == 0)
						L1Teleport.teleport(pc, 32746, 32803, (short) 16384, pc.getMoveState().getHeading(), true); // 용던
																													// 3층

					else if (map > 0)
						if (nowX < 32641 && nowX > 32621 && nowY < 32760 && nowY > 32740)
							L1Teleport.teleport(pc, 32744, 32803, (short) 17408, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 32638 && nowX > 32618 && nowY < 33177 && nowY > 33157)
							L1Teleport.teleport(pc, 32745, 32803, (short) 20480, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33995 && nowX > 33975 && nowY < 33322 && nowY > 33302)
							L1Teleport.teleport(pc, 32745, 32803, (short) 24576, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33447 && nowX > 33427 && nowY < 32799 && nowY > 32779)
							L1Teleport.teleport(pc, 32740, 32803, (short) 18432, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33615 && nowX > 33595 && nowY < 33285 && nowY > 33265)
							L1Teleport.teleport(pc, 32745, 32803, (short) 22528, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33126 && nowX > 33106 && nowY < 33389 && nowY > 33369)
							L1Teleport.teleport(pc, 32745, 32803, (short) 21504, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 34078 && nowX > 34058 && nowY < 32264 && nowY > 32244)
							L1Teleport.teleport(pc, 32745, 32803, (short) 19456, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

				} else if (pc.getInventory().checkItem(40312)) {
					if (map == 0)
						L1Teleport.teleport(pc, 32744, 32808, (short) 16896, pc.getMoveState().getHeading(), true); // 용던
																													// 3층

					else if (map > 0)
						if (nowX < 32641 && nowX > 32621 && nowY < 32760 && nowY > 32740)
							L1Teleport.teleport(pc, 32745, 32807, (short) 18944, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 32638 && nowX > 32618 && nowY < 33177 && nowY > 33157)
							L1Teleport.teleport(pc, 32745, 32807, (short) 19968, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33995 && nowX > 33975 && nowY < 33322 && nowY > 33302)
							L1Teleport.teleport(pc, 32745, 32807, (short) 20992, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33447 && nowX > 33427 && nowY < 32799 && nowY > 32779)
							L1Teleport.teleport(pc, 32745, 32807, (short) 22016, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33615 && nowX > 33595 && nowY < 33285 && nowY > 33265)
							L1Teleport.teleport(pc, 32745, 32807, (short) 23040, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 33126 && nowX > 33106 && nowY < 33389 && nowY > 33369)
							L1Teleport.teleport(pc, 32745, 32807, (short) 24064, pc.getMoveState().getHeading(), true); // 용던
																														// 3층

						else if (nowX < 34078 && nowX > 34058 && nowY < 32264 && nowY > 32244)
							L1Teleport.teleport(pc, 32745, 32807, (short) 25088, pc.getMoveState().getHeading(), true); // 용던
																														// 3층
			...
			if (clan != null) {
				...
				if (castle_id != 0) {
					...
					if (l1castle.getPublicMoney() <= 0)
						return;
					pc.sendPackets(new S_Drawal(pc.getId(), l1castle.getPublicMoney())); // 일단주석
				}
			}
		} else if (s.equalsIgnoreCase("cdeposit")) {// 자금입금
			pc.sendPackets(new S_Deposit(pc.getId())); // 일단주석
			...
			L1ItemInstance item = pc.getInventory().getItemEquipped(2, 2); // int[] allBuffSkill =
																			// {21,26,42,48,54,79,148,151,164};
			if (item != null) {
				L1SkillUse l1skilluse = new L1SkillUse();
				l1skilluse.handleCommands(pc, L1SkillId.BLESSED_ARMOR, item.getId(), 0, 0, null, 0,
						L1SkillUse.TYPE_SPELLSC);
				/*
				 * l1skilluse.handleCommands(pc, L1SkillId.PHYSICAL_ENCHANT_DEX, item.getId(),
				 * 0, 0, null, 0, L1SkillUse.TYPE_SPELLSC); l1skilluse.handleCommands(pc,
				 * L1SkillId.PHYSICAL_ENCHANT_STR, item.getId(), 0, 0, null, 0,
				 * L1SkillUse.TYPE_SPELLSC); l1skilluse.handleCommands(pc,
				 * L1SkillId.BLESS_WEAPON, item.getId(), 0, 0, null, 0,
				 * L1SkillUse.TYPE_SPELLSC); l1skilluse.handleCommands(pc,
				 * L1SkillId.GREATER_HASTE, item.getId(), 0, 0, null, 0,
				 * L1SkillUse.TYPE_SPELLSC); l1skilluse.handleCommands(pc,
				 * L1SkillId.ADVANCE_SPIRIT, item.getId(), 0, 0, null, 0,
				 * L1SkillUse.TYPE_SPELLSC); l1skilluse.handleCommands(pc,
				 * L1SkillId.FIRE_WEAPON, item.getId(), 0, 0, null, 0, L1SkillUse.TYPE_SPELLSC);
				 * l1skilluse.handleCommands(pc, L1SkillId.EARTH_SKIN, item.getId(), 0, 0, null,
				 * 0, L1SkillUse.TYPE_SPELLSC); l1skilluse.handleCommands(pc,
				 * L1SkillId.NATURES_BLESSING, item.getId(), 0, 0, null, 0,
				 * L1SkillUse.TYPE_SPELLSC);
				 */
			} else {
				pc.sendPackets(new S_ServerMessage(79));
			...
			if (npcId == 80085) {
				...
				if (pc.getInventory().checkItem(L1ItemId.REMINISCING_CANDLE)) {
					...
					L1Teleport.teleport(pc, 32723 + _random.nextInt(10), 32851 + _random.nextInt(10), (short) 5166, 5,
							true);
					StatInitialize(pc);
					htmlid = "";
				} else {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 4208002) {// 기란 감옥 멀린 리뉴얼
			if (s.equals("teleport giranD")) {// 액션코드
				if (pc.getLevel() >= Config.기감렙제) {
					//System.out.println("pc.getAccount().getGiranPrisonTime()="+pc.getAccount().getGiranPrisonTime());
					if (pc.getAccount().getGiranPrisonTime() < Config.기감시간) {
						if (pc.getInventory().checkItem(40308, 20000)) {
							...
							L1Location _loc = new L1Location(32810, 32731, (short) 53);
							L1Location loc2 = L1Location.randomLocation(_loc, 0, 20, true);
							L1Teleport.teleport(pc, loc2.getX(), loc2.getY(), (short) loc2.getMapId(), 5, true);
							doTeleport(pc);
						} else {
							pc.sendPackets(new S_SystemMessage("\\fT아데나(20,000) 부족합니다."));
						}
					} else {
						pc.sendPackets(new S_SystemMessage("\\fT기감 사냥시간이 모두 소진되었습니다."));
					}
				} else {
					pc.sendPackets(new S_SystemMessage(Config.기감렙제 + "렙부터 기감 사냥이 가능합니다."));
				}
			}
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 9000014) {
			if (s.equals("a")) {
				if (pc.getWanted() == 0  && WantedTeleportTable.getInstance().isWantedTeleportMap(781)) {
					pc.sendPackets(new S_SystemMessage("\\fT수배 상태에서만 사냥터로 이동 가능합니다."));
					return;
				}
				if (pc.getLevel() >= Config.테베렙제) {
					L1Location loc = new L1Location(32743, 32796, 781);
					L1Location location = L1Location.randomLocation(loc, 0, 100, true);
					L1Teleport.teleport(pc, location.getX(), location.getY(), (short) location.getMapId(), pc.getHeading(), true);
				} else {
					pc.sendPackets(new S_SystemMessage(Config.테베렙제 + "렙부터 테베라스 사냥이 가능합니다."));
				}
				
			} else {
				htmlid = "teberas";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 900001609) {
			if (s.equals("a")) {
				L1Teleport.teleport(pc, 32726, 32729, (short) 13, 2, true);
			} else {
				htmlid = "gludio";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 900001610) {
			if (s.equals("a")) {
				L1Teleport.teleport(pc, 32734, 32864, (short) 200, 2, true);
			} else {
				htmlid = "omantop";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 9000015) {
			if (s.equals("a")) {

				L1Teleport.teleport(pc, 32722, 32795, (short) 536, 2, true);
			...
			L1Teleport.teleport(pc, 32807, 32734, (short) 53, 2, true);
		} else if (s.equalsIgnoreCase("contract1")) {
			pc.getQuest().set_step(L1Quest.QUEST_LYRA, 1);
			htmlid = "lyraev2";
		} else if (s.equalsIgnoreCase("contract1yes") || s.equalsIgnoreCase("contract1no")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80082) { // 낚시꼬마(IN)d
			// 「길고 무거운 낚싯대」
			if (s.equalsIgnoreCase("a")) {
				if (pc.getInventory().checkItem(L1ItemId.ADENA, 0)) {
					L1PolyMorph.undoPoly(pc);
					L1Teleport.teleport(pc, 32742, 32799, (short) 5302, 6, true);
				} else {
					htmlid = "fk_in_0";
				}
				// 「짧고 가벼운 낚싯대」
			...
			if (s.equalsIgnoreCase("a") || s.equalsIgnoreCase("teleport fishing-out")
				...
				/*
				 * if (!pc.getInventory().checkItem(41294, 1) &&
				 * !pc.getInventory().checkItem(41294, 1)) { htmlid = "fk_out_0"; } else if
				 * (pc.getInventory().consumeItem(41294, 1)) { L1Teleport.teleport(pc, 32613,
				 * 32781, (short) 4, 4, true); } else if (pc.getInventory().consumeItem(41294,
				 * 1)) { L1Teleport.teleport(pc, 32613, 32781, (short) 4, 4, true); }
				 */
			}
			...
			if (s.equalsIgnoreCase("chg")) {
				if (pc.getPartnerId() != 0) {
					...
					if (pc.getInventory().checkItem(40903) || pc.getInventory().checkItem(40904)
							|| pc.getInventory().checkItem(40905) || pc.getInventory().checkItem(40906)
							|| pc.getInventory().checkItem(40907) || pc.getInventory().checkItem(40908)) {
						if (pc.getInventory().checkItem(L1ItemId.ADENA, 1000)) {
							int chargeCount = 0;
			...
			if (s.equalsIgnoreCase("A")) {// 복원된 고대의 목걸이
				...
				if (pc.getInventory().checkItem(49028, 1) && pc.getInventory().checkItem(49029, 1)
						&& pc.getInventory().checkItem(49030, 1) && pc.getInventory().checkItem(41139, 1)) { // 보석과 볼품없는
																												// 목걸이
																												// 확인
			...
			/***************************** 추가 부분 *****************************/
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777835 || ((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 900009622) { // 젠도르
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getCurrentWeapon() != 20) { // 근거리
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 77777) { // 오림제작
			// if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
			if (pc.getInventory().checkItem(7323, 3)) {
				...
				if (chance <= 25) {// 1이 25퍼
					createNewItem2(pc, 7324, 1, 0); // 축오림
					pc.sendPackets(new S_SystemMessage("성공하였니다."));
					pc.sendPackets(new S_SkillSound(pc.getId(), 8473));
					pc.broadcastPacket(new S_SkillSound(pc.getId(), 8473));
				} else {
					pc.sendPackets(new S_SystemMessage("실패하였습니다."));
				}

			} else {
				pc.sendPackets(new S_SystemMessage("주문서 재료가 부족합니다."));
			}
			// }
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 70865) { // 젠도르
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 0)) {
					pc.getInventory().consumeItem(40308, 0);
					int[] allBuffSkill = Config.Zendor_Buff;
					L1SkillUse l1skilluse = new L1SkillUse();
					for (int i = 0; i < allBuffSkill.length; i++) {
						l1skilluse.handleCommands(pc, allBuffSkill[i], pc.getId(), pc.getX(), pc.getY(), null, 0,
								L1SkillUse.TYPE_GMBUFF);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777836) { // 성혈버프-메티스버프동상 <<이거로복사해서쓰고이성요
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 0)) {
					pc.getInventory().consumeItem(40308, 0);
					int[] allBuffSkill = Config.Metice_Buff;
					// int[] allBuffSkill = {21,26,42,48,54,79,148,151,164};//Metice_Buff
					L1SkillUse l1skilluse = new L1SkillUse();
					for (int i = 0; i < allBuffSkill.length; i++) {
						l1skilluse.handleCommands(pc, allBuffSkill[i], pc.getId(), pc.getX(), pc.getY(), null, 0,
								L1SkillUse.TYPE_GMBUFF);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777840) { // 오만의탑10층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32800, 32800, (short) 110, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777841) { // 오만의탑20층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32753, 32740, (short) 120, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777842) { // 오만의탑30층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32753, 32740, (short) 130, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777843) { // 오만의탑40층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32753, 32740, (short) 140, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777844) { // 오만의탑50층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32753, 32740, (short) 150, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777845) { // 오만의탑60층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32680, 32814, (short) 160, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777846) { // 오만의탑70층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32633, 32789, (short) 170, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777847) { // 오만의탑80층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32633, 32790, (short) 180, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777848) { // 오만의탑90층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32632, 32790, (short) 190, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 777849) { // 오만의탑90층
			if (s.equalsIgnoreCase("a")) { // 마법을 받는다.
				if (pc.getInventory().checkItem(40308, 3000)) {
					pc.getInventory().consumeItem(40308, 3000);
					L1Teleport.teleport(pc, 32632, 32974, (short) 200, 2, true);
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 9000020) { // 네오 제작 용티제작
			int chance = _random.nextInt(100) + 1;// 리퍼 소환 확률
			if (s.equals("a36")) {
				if (chance <= Config.일층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370617, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 1층 부적이 제작 되었습니다.."));
					}

				} else {

					pc.sendPackets(new S_SystemMessage("재료가 없거나 제작에 실패 하였습니다."));
					return;
				}
			} else if (s.equals("a37")) {
				if (chance <= Config.이층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370618, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 2층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a38")) {
				if (chance <= Config.삼층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370619, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 3층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a39")) {
				if (chance <= Config.사층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370620, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 4층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a40")) {
				if (chance <= Config.오층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370621, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 5층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a41")) {
				if (chance <= Config.육층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370622, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 6층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a42")) {
				if (chance <= Config.칠층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370623, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 7층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a43")) {
				if (chance <= Config.팔층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370624, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 8층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a44")) {
				if (chance <= Config.구층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370625, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 9층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a45")) {
				if (chance <= Config.십층지배확률) {
					if (pc.getInventory().checkItem(40280, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
						pc.getInventory().consumeItem(40280, 1);
						pc.getInventory().consumeItem(40308, 10000000);
						pc.getInventory().storeItem(5370626, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY오만탑의 지배 10층 부적이 제작 되었습니다.."));
					}
			...
			} else if (s.equals("a46")) {
				if (chance <= Config.축오림제작확률) {
					if (pc.getInventory().checkItem(7323, 3)) { //
						pc.getInventory().consumeItem(7323, 3);

						pc.getInventory().storeItem(7324, 1, 0); // 거대금빛날개
						pc.sendPackets(new S_SystemMessage("\\fY축복 받은 오림의 장신구 주문서를 제작에 성공 하였습니다."));
					}

				} else {
					pc.getInventory().consumeItem(7323, 2);
					pc.sendPackets(new S_SystemMessage("재료가 없거나 제작에 실패 하였습니다."));
					return;
				}
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 70742) { // 네오 제작 엔피씨
			if (s.equals("a1")) {
				if (pc.getInventory().checkItem(20095, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
					pc.getInventory().consumeItem(20095, 1);
					pc.getInventory().consumeItem(40308, 10000000);
					pc.getInventory().storeItem(23100, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 판금 갑옷이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a2")) {
				if (pc.getInventory().checkItem(20092, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
					pc.getInventory().consumeItem(20092, 1);
					pc.getInventory().consumeItem(40308, 10000000);
					pc.getInventory().storeItem(23102, 1, 0, 1); // 멸마의 가죽 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 가죽 갑옷이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a3")) {
				if (pc.getInventory().checkItem(20094, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
					pc.getInventory().consumeItem(20094, 1);
					pc.getInventory().consumeItem(40308, 10000000);
					pc.getInventory().storeItem(23101, 1, 0, 1); // 멸마의 비늘 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 비늘 갑옷이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a4")) {
				if (pc.getInventory().checkItem(20093, 1) && pc.getInventory().checkItem(40308, 10000000)) { //
					pc.getInventory().consumeItem(20093, 1);
					pc.getInventory().consumeItem(40308, 10000000);
					pc.getInventory().storeItem(23103, 1, 0, 1); // 멸마의 로브
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 로브가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a5")) {
				if (pc.getInventory().checkEnchantItem(120056, 9, 1) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeEnchantItem(120056, 9, 1);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20049, 1, 0, 1); // 거대금빛날개
					pc.sendPackets(new S_SystemMessage("\\fY거대 여왕 개미의 금빛 날개가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
				...
				if (pc.getInventory().checkEnchantItem(120056, 9, 1) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeEnchantItem(120056, 9, 1);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20050, 1, 0, 1); // 거대은빛날개
					pc.sendPackets(new S_SystemMessage("\\fY거대 여왕 개미의 은빛 날개가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
				...
				if (pc.getInventory().checkEnchantItem(120056, 9, 1) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeEnchantItem(120056, 9, 1);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20079, 1, 0, 1); // 뱀망
					pc.sendPackets(new S_SystemMessage("\\fY뱀파이어의 망토가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a8")) {
				if (pc.getInventory().checkEnchantItem(120056, 8, 1) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeEnchantItem(120056, 8, 1);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20074, 1, 0, 1); // 은색망토
					pc.sendPackets(new S_SystemMessage("\\fY은색의 망토가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a9")) {
				if (pc.getInventory().checkItem(40638, 50) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeItem(40638, 50);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20200, 1, 0, 1); // 마수군왕의부츠
					pc.sendPackets(new S_SystemMessage("\\fY마수군왕의 부츠가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a10")) {
				if (pc.getInventory().checkItem(40667, 50) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeItem(40667, 50);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20178, 1, 0, 1); // 암살군왕의장갑
					pc.sendPackets(new S_SystemMessage("\\fY암살군왕의 장갑가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a11")) {
				if (pc.getInventory().checkItem(40642, 50) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeItem(40642, 50);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20057, 1, 0, 1); // 명법군왕의망토
					pc.sendPackets(new S_SystemMessage("\\fY명법군왕의 망토가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a12")) {
				if (pc.getInventory().checkItem(40635, 50) && pc.getInventory().checkItem(40308, 20000000)) { //
					pc.getInventory().consumeItem(40635, 50);
					pc.getInventory().consumeItem(40308, 20000000);
					pc.getInventory().storeItem(20109, 1, 0, 1); // 마령군왕의 로브
					pc.sendPackets(new S_SystemMessage("\\fY마령군왕의 로브가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			...
			// 2008년 산타 버프이벤트
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 46201) { // 네오 왕도집행 제작
			if (s.equals("craftwangdo")) {
				if (pc.getInventory().checkItem(40466, 1) && pc.getInventory().checkItem(40308, 3000000)) { //
					pc.getInventory().consumeItem(40466, 1);
					pc.getInventory().consumeItem(40308, 3000000);

					pc.getInventory().storeItem(84, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY흑왕도가 제작되었습니다.."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("craftwangah")) {
				if (pc.getInventory().checkItem(40466, 1) && pc.getInventory().checkItem(40308, 3000000)) { //
					pc.getInventory().consumeItem(40466, 1);
					pc.getInventory().consumeItem(40308, 1000000);
					pc.getInventory().storeItem(164, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY흑왕아가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("craftwangun")) {
				if (pc.getInventory().checkItem(40466, 1) && pc.getInventory().checkItem(40308, 3000000)) { //
					pc.getInventory().consumeItem(40466, 1);
					pc.getInventory().consumeItem(40308, 1000000);
					pc.getInventory().storeItem(189, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY흑왕궁이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("myulP")) {
				if (pc.getInventory().checkItem(20095, 2) && pc.getInventory().checkItem(40308, 5000000)) { //
					pc.getInventory().consumeItem(20095, 2);
			...
			} else if (s.equals("myulG")) {
				if (pc.getInventory().checkItem(20092, 2) && pc.getInventory().checkItem(40308, 5000000)) { //
					pc.getInventory().consumeItem(20092, 2);
					pc.getInventory().consumeItem(40308, 5000000);
					pc.getInventory().storeItem(23102, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 가죽 갑옷이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("myulL")) {
				if (pc.getInventory().checkItem(20093, 2) && pc.getInventory().checkItem(40308, 5000000)) { //
					pc.getInventory().consumeItem(20093, 2);
					pc.getInventory().consumeItem(40308, 5000000);
					pc.getInventory().storeItem(23103, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 로브가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("myulB")) {
				if (pc.getInventory().checkItem(20094, 2) && pc.getInventory().checkItem(40308, 5000000)) { //
					pc.getInventory().consumeItem(20094, 2);
					pc.getInventory().consumeItem(40308, 5000000);
					pc.getInventory().storeItem(23101, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY멸마의 비늘 갑옷이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("jinK")) {
				if (pc.getInventory().checkItem(40965, 1) && pc.getInventory().checkItem(40308, 30000000)) { //
					pc.getInventory().consumeItem(40965, 1);
					pc.getInventory().consumeItem(40308, 30000000);
					pc.getInventory().storeItem(61, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY진명황의 집행검이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("jinD")) {
				if (pc.getInventory().checkItem(40965, 1) && pc.getInventory().checkItem(40308, 30000000)) { //
					pc.getInventory().consumeItem(40965, 1);
					pc.getInventory().consumeItem(40308, 30000000);
					pc.getInventory().storeItem(86, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY붉은 그림자의 이도류가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("jinE")) {
				if (pc.getInventory().checkItem(40965, 1) && pc.getInventory().checkItem(40308, 30000000)) { //
					pc.getInventory().consumeItem(40965, 1);
					pc.getInventory().consumeItem(40308, 30000000);
					pc.getInventory().storeItem(12, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY바람칼날의 단검이 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("jinEE")) {
				if (pc.getInventory().checkItem(40965, 1) && pc.getInventory().checkItem(40308, 30000000)) { //
					pc.getInventory().consumeItem(40965, 1);
					pc.getInventory().consumeItem(40308, 30000000);
					pc.getInventory().storeItem(450009, 1, 0, 1); //
					pc.sendPackets(new S_SystemMessage("\\fY가이아의 격노가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("jinW")) {
				if (pc.getInventory().checkItem(40965, 1) && pc.getInventory().checkItem(40308, 30000000)) { //
					pc.getInventory().consumeItem(40965, 1);
					pc.getInventory().consumeItem(40308, 30000000);
					pc.getInventory().storeItem(134, 1, 0, 1); // 멸마의 판금 갑옷
					pc.sendPackets(new S_SystemMessage("\\fY수정 결정체 지팡이가 제작 되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("gcraft5")) {
				int chance = _random.nextInt(100) + 1;
				if (pc.getInventory().checkItem(20288, 2) && pc.getInventory().checkItem(40308, 3000000)) {
					if (chance < Config.지배순반제작확률) {
						pc.getInventory().consumeItem(20288, 2);
						pc.getInventory().consumeItem(40308, 3000000);
						pc.getInventory().storeItem(120288, 1, 0, 1);
						pc.sendPackets(new S_SystemMessage("\\fY순간이동 지배 반지가 제작 되었습니다."));
					} else {
						pc.getInventory().consumeItem(20288, 1);
						pc.getInventory().consumeItem(40308, 3000000);
						pc.sendPackets(new S_SystemMessage("\\fY순간이동 지배 반지 제작이 실패하였습니다."));
					}
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
			...
			// 2008년 산타 버프이벤트
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 9000018) { // 네오 왕도집행 제작
			if (s.equals("a13")) {
				if (pc.getInventory().checkEnchantItem(59, 10, 1) && pc.getInventory().checkItem(40308, 100000000)) { //
					pc.getInventory().consumeEnchantItem(59, 10, 1);
					pc.getInventory().consumeItem(40308, 100000000);
					pc.getInventory().storeItem(66, 1, 0, 1); // 거대여왕개미의 금빛 날개
					pc.sendPackets(new S_SystemMessage("\\fY드래곤 슬레이어가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a14")) {
				if (pc.getInventory().checkEnchantItem(121, 10, 1) && pc.getInventory().checkItem(40308, 100000000)) { //
					pc.getInventory().consumeEnchantItem(121, 10, 1);
					pc.getInventory().consumeItem(40308, 100000000);
					pc.getInventory().storeItem(450008, 1, 0, 1); // 거대여왕개미의 금빛 날개
					pc.sendPackets(new S_SystemMessage("\\fY제로스 지팡이가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a15")) {
				if (pc.getInventory().checkEnchantItem(205, 10, 1) && pc.getInventory().checkItem(40308, 100000000)) { //
					pc.getInventory().consumeEnchantItem(205, 10, 1);
					pc.getInventory().consumeItem(40308, 100000000);
					pc.getInventory().storeItem(205, 1, 0, 1); // 거대여왕개미의 금빛 날개
					pc.sendPackets(new S_SystemMessage("\\fY악몽의 장궁이 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a16")) {
				if (pc.getInventory().checkEnchantItem(84, 10, 1) && pc.getInventory().checkItem(40308, 100000000)) { //
					pc.getInventory().consumeEnchantItem(84, 10, 1);
					pc.getInventory().consumeItem(40308, 100000000);
					pc.getInventory().storeItem(450010, 1, 0, 1); // 거대여왕개미의 금빛 날개
					pc.sendPackets(new S_SystemMessage("\\fY포효의 이도류가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			} else if (s.equals("a17")) {
				if (pc.getInventory().checkEnchantItem(54, 10, 1) && pc.getInventory().checkItem(40308, 100000000)) { //
					pc.getInventory().consumeEnchantItem(54, 10, 1);
					pc.getInventory().consumeItem(40308, 100000000);
					pc.getInventory().storeItem(450011, 1, 0, 1); // 거대여왕개미의 금빛 날개
					pc.sendPackets(new S_SystemMessage("\\fY진 레이피어가 제작되었습니다."));
				} else {
					pc.sendPackets(new S_SystemMessage("재료가 부족합니다."));
					return;
				}
			...
			if (pc.getLevel() <= 52) {
				...
				for (int i = 0; i < buff.length; i++) {
					new L1SkillUse().handleCommands(pc, i, pc.getId(), pc.getX(), pc.getY(), null, 0,
							L1SkillUse.TYPE_GMBUFF);
				}
				htmlid = "2008santa1";
			} else {
			...
			/***************************** 시간의 균열 ********************************/
			// 테베 문지기
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 700912) {
			if (s.equalsIgnoreCase("a")) {
			...
			if (s.equalsIgnoreCase("e")) {
				if (CrockSystem.getInstance().isCrockIng()) {// 연장상태면
					...
					new L1SkillUse().handleCommands(pc, L1SkillId.STATUS_TIKAL_BOSSJOIN, pc.getId(), pc.getX(),
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 4200008) {// 경험치지급단
			if (s.equalsIgnoreCase("0")) {
				if (pc.getLevel() < 51) {
					pc.addExp(
							(ExpTable.getExpByLevel(51) - 1) - pc.getExp() + ((ExpTable.getExpByLevel(51) - 1) / 100));
				...
				if (ExpTable.getLevelByExp(pc.getExp()) >= Config.경험치지급단) {
					htmlid = "expgive3";
					pc.sendPackets(new S_SystemMessage("경험치 지급단은  Lv.(" + Config.경험치지급단 + ")까지 지급합니다"));
				} else {
					htmlid = "expgive";
				}
			}
			...
			// int keeperId = house.getKeeperId();
			// int rank = pc.getClanRank();
			// if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == keeperId &&
			// house.isPurchaseBasement()) {
	...
	private boolean useBeginnerTeleportBook(L1PcInstance pc, int itemId, String s) {
		...
		if (s.equals("A11")) {
			...
			L1Teleport.teleport(pc, 32571, 32886, (short) 0, pc.getMoveState().getHeading(), true); // 말하는섬[필드]
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 33079, 33301, (short) 4, pc.getMoveState().getHeading(), true); // 은기사 마을[필드]
			isUseItem = true;
		} else if (s.equals("B13")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32599, 33275, (short) 4, pc.getMoveState().getHeading(), true); // 포도밭
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32827, 33267, (short) 4, pc.getMoveState().getHeading(), true); // 오아시스
			isUseItem = true;
		} else if (s.equals("B15")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32880, 32651, (short) 4, pc.getMoveState().getHeading(), true); // 카오틱신전
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 33119, 32933, (short) 4, pc.getMoveState().getHeading(), true); // 라우플신전
			isUseItem = true;
		} else if (s.equals("B17")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32804, 32808, (short) 25, pc.getMoveState().getHeading(), true); // 수련던전 1층
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32802, 32815, (short) 26, pc.getMoveState().getHeading(), true); // 수련던전 2층
			isUseItem = true;
		} else if (s.equals("C13")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33717, 32956, (short) 4, pc.getMoveState().getHeading(), true); // 싸이 밭
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 33335, 32442, (short) 4, pc.getMoveState().getHeading(), true); // 용계 삼거리
			isUseItem = true;
		} else if (s.equals("D15")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33387, 32345, (short) 4, pc.getMoveState().getHeading(), true); // 용계[용뼈]
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32806, 32811, (short) 27, pc.getMoveState().getHeading(), true); // 수련 던전[3층]
			isUseItem = true;
		} else if (s.equals("D17")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32798, 32798, (short) 28, pc.getMoveState().getHeading(), true); // 수련 던전[4층]
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32892, 32770, (short) 78, pc.getMoveState().getHeading(), true); // 상아탑[4층]
			isUseItem = true;
		} else if (s.equals("D19")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32772, 32804, (short) 79, pc.getMoveState().getHeading(), true); // 상아탑[5층]
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32748, 32802, (short) 80, pc.getMoveState().getHeading(), true); // 상아탑[6층]
			isUseItem = true;
		} else if (s.equals("D21")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32766, 32849, (short) 81, pc.getMoveState().getHeading(), true); // 상아탑[7층]
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32798, 32754, (short) 9, pc.getMoveState().getHeading(), true); // 글루디오 던전[3층]
			isUseItem = true;
		} else if (s.equals("D23")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32764, 32773, (short) 10, pc.getMoveState().getHeading(), true); // 글루디오 던전[4층]
			isUseItem = true;
			...
			L1Teleport.teleport(pc, 32740, 32777, (short) 30, pc.getMoveState().getHeading(), true); // 용의계곡 던전[1층]
			isUseItem = true;
		} else if (s.equals("D25")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32760, 32781, (short) 31, pc.getMoveState().getHeading(), true); // 용의계곡 던전[2층]
			isUseItem = true;
		} else if (s.equals("D26")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32709, 32818, (short) 32, pc.getMoveState().getHeading(), true); // 용의계곡 던전[3층]
			isUseItem = true;
		} else if (s.equals("E15")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 34038, 32475, (short) 4, pc.getMoveState().getHeading(), true); // 엘모어 밭
			isUseItem = true;
		} else if (s.equals("F16")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32742, 32798, (short) 82, pc.getMoveState().getHeading(), true); // 상아탑[8층]
			isUseItem = true;
		} else if (s.equals("F17")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32802, 32872, (short) 63, pc.getMoveState().getHeading(), true); // 에바왕국[4층]
			isUseItem = true;
		} else if (s.equals("F18")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33673, 32415, (short) 4, pc.getMoveState().getHeading(), true); // 화룡의 둥지[필드]
			isUseItem = true;
		} else if (s.equals("F19")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32729, 32724, (short) 11, pc.getMoveState().getHeading(), true); // 글루디오 던전[5층]
			isUseItem = true;
		} else if (s.equals("F20")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32805, 32727, (short) 12, pc.getMoveState().getHeading(), true); // 글루디오 던전[6층]
			isUseItem = true;
		} else if (s.equals("F21")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32669, 32869, (short) 33, pc.getMoveState().getHeading(), true); // 용의계곡 던전[4층]
			isUseItem = true;
		} else if (s.equals("F22")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32746, 32802, (short) 35, pc.getMoveState().getHeading(), true); // 용의계곡 던전[5층]
			isUseItem = true;
		} else if (s.equals("F23")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			if (pc.getWanted() == 0) {
				pc.sendPackets(new S_SystemMessage("\\fY수배상태에서만 이동이 가능합니다."));
				return false;
			}
			L1Teleport.teleport(pc, 32726, 32729, (short) 13, pc.getMoveState().getHeading(), true); // 글루디오 던전[7층]
			isUseItem = true;
		} else if (s.equals("F24")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			L1Teleport.teleport(pc, 32663, 32846, (short) 36, pc.getMoveState().getHeading(), true); // 용의계곡 던전[6층]
			isUseItem = true;
		}
		return isUseItem;
	}

	private boolean useJinPolyList(L1PcInstance pc, int itemId, String s) {
		boolean isUseItem = false;
		L1ItemInstance item = pc.getInventory().findItemId(45109);
		if (s.equals("jinknight")) {
			L1PolyMorph.doPoly(pc, 17541, 7200, L1PolyMorph.MORPH_BY_GM);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinshadow")) {
			L1PolyMorph.doPoly(pc, 17531, 7200, L1PolyMorph.MORPH_BY_GM);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinlancer")) {
			L1PolyMorph.doPoly(pc, 17545, 7200, L1PolyMorph.MORPH_BY_GM);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinacher")) {
			L1PolyMorph.doPoly(pc, 17535, 7200, L1PolyMorph.MORPH_BY_GM);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jungader")) {
			L1PolyMorph.doPoly(pc, 17549, 7200, L1PolyMorph.MORPH_BY_GM);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinbapo")) {
			L1PolyMorph.doPoly(pc, 17515, 7200, L1PolyMorph.MORPH_BY_GM);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		}
		return isUseItem;
	...
	private boolean useJinPolyList1(L1PcInstance pc, int itemId, String s) {
		boolean isUseItem = false;
		L1ItemInstance item = pc.getInventory().findItemId(430634);
		if (s.equals("jinknight")) {
			L1PolyMorph.doPoly(pc, 17541, 3600, L1PolyMorph.MORPH_BY_ITEMMAGIC);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinshadow")) {
			L1PolyMorph.doPoly(pc, 17531, 3600, L1PolyMorph.MORPH_BY_ITEMMAGIC);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinlancer")) {
			L1PolyMorph.doPoly(pc, 17545, 3600, L1PolyMorph.MORPH_BY_ITEMMAGIC);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinacher")) {
			L1PolyMorph.doPoly(pc, 17535, 3600, L1PolyMorph.MORPH_BY_ITEMMAGIC);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jungader")) {
			L1PolyMorph.doPoly(pc, 17549, 3600, L1PolyMorph.MORPH_BY_ITEMMAGIC);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		} else if (s.equals("jinbapo")) {
			L1PolyMorph.doPoly(pc, 17515, 3600, L1PolyMorph.MORPH_BY_ITEMMAGIC);
			pc.sendPackets(new S_CloseList(pc.getId()));
			isUseItem = true;
		}
		if (isUseItem) {
	...
	private boolean useJoeTeleportBook(L1PcInstance pc, int itemId, String s) {
		if (pc.getMapId() == 70) {
			pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			pc.sendPackets(new S_ServerMessage(647));
		...
		boolean isUseItem = false;
		L1ItemInstance item = pc.getInventory().findItemId(52065);
		if (s.equals("A")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
			...
			L1Teleport.teleport(pc, 32671, 32796, (short) 82, pc.getMoveState().getHeading(), true); // 상아탑 8층
			isUseItem = true;
		} else if (s.equals("B")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32754, 32839, (short) 309, pc.getMoveState().getHeading(), true); // 침공로 3층
			isUseItem = true;
		} else if (s.equals("C")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32709, 32818, (short) 32, pc.getMoveState().getHeading(), true); // 용던 3층
			isUseItem = true;
		} else if (s.equals("D")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 33979, 32926, (short) 4, pc.getMoveState().getHeading(), true); // 몽섬
			isUseItem = true;
		} else if (s.equals("E")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32800, 33051, (short) 420, pc.getMoveState().getHeading(), true); // 지저호수
			isUseItem = true;
		} else if (s.equals("F")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32918, 32865, (short) 430, pc.getMoveState().getHeading(), true); // 정령의 무덤
			isUseItem = true;
		} else if (s.equals("G")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32811, 32726, (short) 807, pc.getMoveState().getHeading(), true); // 본던 1층
			isUseItem = true;
		} else if (s.equals("Q")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32832, 32699, (short) 550, pc.getMoveState().getHeading(), true); // 선박의 무덤
			isUseItem = true;
		} else if (s.equals("H")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32810, 32730, (short) 53, pc.getMoveState().getHeading(), true); // 기감 1층
			isUseItem = true;
		} else if (s.equals("I")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32828, 32961, (short) 430, pc.getMoveState().getHeading(), true); // 정무 2구역
			isUseItem = true;
		} else if (s.equals("J")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32763, 32774, (short) 810, pc.getMoveState().getHeading(), true); // 본던 4층
			isUseItem = true;
			// 고 레벨 사냥터
		} else if (s.equals("K")) {
			if (pc.getMapId() == 70) {
			...
			L1Teleport.teleport(pc, 32928, 32993, (short) 410, pc.getMoveState().getHeading(), true); // 32928 32993 410
																										// 마족
			isUseItem = true;
		} else if (s.equals("L")) {
			if (pc.getMapId() == 70) {
			...
			L1Teleport.teleport(pc, 32855, 32945, (short) 400, pc.getMoveState().getHeading(), true); // 32855 32945 400
																										// 거인의무덤
			isUseItem = true;
		} else if (s.equals("M")) {
			if (pc.getMapId() == 70) {
			...
			L1Teleport.teleport(pc, 32729, 32847, (short) 451, pc.getMoveState().getHeading(), true); // 32729 32847 451
																										// 라던집회장
			isUseItem = true;
		} else if (s.equals("N")) {
			if (pc.getMapId() == 70) {
			...
			L1Teleport.teleport(pc, 32673, 32867, (short) 457, pc.getMoveState().getHeading(), true); // 32729 32847 451
																										// 1층 결계
			isUseItem = true;
		} else if (s.equals("O")) {
			...
			L1Teleport.teleport(pc, 32667, 32855, (short) 467, pc.getMoveState().getHeading(), true); // 32673 32867 457
																										// 라던2층결계
			isUseItem = true;
		} else if (s.equals("P")) {
			if (pc.getMapId() == 70) {
			...
			L1Teleport.teleport(pc, 32745, 32790, (short) 536, pc.getMoveState().getHeading(), true); // 3층 결계
			isUseItem = true;
		} else if (s.equals("Q1")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32763, 32774, (short) 810, pc.getMoveState().getHeading(), true); // 얼던
			isUseItem = true;
		}
		if (isUseItem) {
			pc.getInventory().removeItem(item, 1);
	...
	private boolean useJoeTeleportBook1(L1PcInstance pc, int itemId, String s) {
		boolean isUseItem = false;
		L1ItemInstance item = pc.getInventory().findItemId(52063);
		if (s.equals("tel_001")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
			...
			L1Teleport.teleport(pc, 33118, 32934, (short) 4, pc.getMoveState().getHeading(), true); // 라우풀 신전
			isUseItem = true;
		} else if (s.equals("tel_002")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32885, 32652, (short) 4, pc.getMoveState().getHeading(), true); // 카오틱 신전
			isUseItem = true;
		} else if (s.equals("tel_003")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32422, 33074, (short) 440, pc.getMoveState().getHeading(), true); // 해적섬 마을
			isUseItem = true;
		} else if (s.equals("tel_005")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33052, 32340, (short) 4, pc.getMoveState().getHeading(), true); // 엄마나무
			isUseItem = true;
		} else if (s.equals("tel_040")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32938, 32281, (short) 4, pc.getMoveState().getHeading(), true); // 요던입구
			isUseItem = true;
		} else if (s.equals("tel_036")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32841, 33168, (short) 4, pc.getMoveState().getHeading(), true); // 개미굴 입구 1

		} else if (s.equals("tel_037")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32787, 33253, (short) 4, pc.getMoveState().getHeading(), true); // 개미굴 입구 2
			isUseItem = true;
		} else if (s.equals("tel_006")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32926, 33517, (short) 4, pc.getMoveState().getHeading(), true); // 수련던전2층
			isUseItem = true;
		} else if (s.equals("tel_007")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				isUseItem = false;
			}
			L1Teleport.teleport(pc, 32882, 33511, (short) 4, pc.getMoveState().getHeading(), true); // 수련던전3층
			isUseItem = true;
		} else if (s.equals("tel_008")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				isUseItem = false;
			}
			L1Teleport.teleport(pc, 32799, 32798, (short) 28, pc.getMoveState().getHeading(), true); // 수련던전4층 마족
			isUseItem = true;
		} else if (s.equals("tel_009")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				isUseItem = false;
			}
			L1Teleport.teleport(pc, 32761, 32822, (short) 307, pc.getMoveState().getHeading(), true); // 침공 1층 거인의무덤
			isUseItem = true;
		} else if (s.equals("tel_010")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32750, 32824, (short) 308, pc.getMoveState().getHeading(), true); // 3 침공 2층 라던집회장
			isUseItem = true;
		} else if (s.equals("tel_011")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32757, 32836, (short) 309, pc.getMoveState().getHeading(), true); // 침공 3층 1층 결계
			isUseItem = true;
		} else if (s.equals("tel_015")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32798, 32754, (short) 9, pc.getMoveState().getHeading(), true); // 글루디오던전3층
			isUseItem = true;
		} else if (s.equals("tel_016")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32729, 32724, (short) 11, pc.getMoveState().getHeading(), true); // 글루디오던전5층
			isUseItem = true;
		} else if (s.equals("tel_017")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			if (GludioDungeonController.getInstance().isgameStart == true) {
				L1Teleport.teleport(pc, 32726, 32729, (short) 13, 2, true); // 32806 32728 812 데스
				isUseItem = true;
			} else {
				pc.sendPackets(new S_SystemMessage("\\fY본던7층이 열려있지 않습니다."));
			}
		} else if (s.equals("tel_018")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32742, 32777, (short) 30, pc.getMoveState().getHeading(), true); // 용던 1층
			isUseItem = true;
		} else if (s.equals("tel_019")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			L1Teleport.teleport(pc, 32709, 32818, (short) 32, pc.getMoveState().getHeading(), true); // 용던 3층
			isUseItem = true;
		} else if (s.equals("tel_020")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32746, 32802, (short) 35, pc.getMoveState().getHeading(), true); // 용던 5층
			isUseItem = true;
		} else if (s.equals("tel_021")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 34266, 32190, (short) 4, pc.getMoveState().getHeading(), true); // 그림자 신전
			isUseItem = true;
		} else if (s.equals("tel_022")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32760, 33461, (short) 4, pc.getMoveState().getHeading(), true); // 욕망의동굴
			isUseItem = true;
		} else if (s.equals("tel_023")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32929, 32995, (short) 410, pc.getMoveState().getHeading(), true); // 마족
			isUseItem = true;
		} else if (s.equals("tel_024")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 34270, 33362, (short) 4, pc.getMoveState().getHeading(), true); // 황혼의산맥
			isUseItem = true;
		} else if (s.equals("tel_025")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33978, 32928, (short) 4, pc.getMoveState().getHeading(), true); // 몽섬 입구
			isUseItem = true;
		} else if (s.equals("tel_026")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33669, 32334, (short) 4, pc.getMoveState().getHeading(), true); // 화둥 중앙
			isUseItem = true;
		} else if (s.equals("tel_027")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33726, 32283, (short) 4, pc.getMoveState().getHeading(), true); // 화둥 정상
			isUseItem = true;
		} else if (s.equals("tel_028")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32924, 32800, (short) 430, pc.getMoveState().getHeading(), true); // 정무입구
			isUseItem = true;
		} else if (s.equals("tel_029")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32771, 32879, (short) 400, pc.getMoveState().getHeading(), true); // 고무
			isUseItem = true;
		} else if (s.equals("tel_030")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32780, 32803, (short) 558, pc.getMoveState().getHeading(), true); // 선박
			isUseItem = true;
		} else if (s.equals("tel_031")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32800, 33051, (short) 420, pc.getMoveState().getHeading(), true); // 지저
			isUseItem = true;

		} else if (s.equals("tel_033")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33261, 32405, (short) 4, pc.getMoveState().getHeading(), true); // 작뼈
			isUseItem = true;
		} else if (s.equals("tel_034")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33385, 32348, (short) 4, pc.getMoveState().getHeading(), true); // 큰뼈
			isUseItem = true;
		} else if (s.equals("tel_0041")) { // 말섬 늑인
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32672, 32844, (short) 0, pc.getMoveState().getHeading(), true); // 요던입구
			isUseItem = true;
		} else if (s.equals("tel_042")) { // 말섬 커츠
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32641, 32957, (short) 0, pc.getMoveState().getHeading(), true); // 요던입구
			isUseItem = true;
		} else if (s.equals("tel_043")) { // 말섬 바포
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32491, 32864, (short) 0, pc.getMoveState().getHeading(), true); // 요던입구
			isUseItem = true;
		} else if (s.equals("tel_044")) { // 말섬 셀로브
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32436, 33013, (short) 0, pc.getMoveState().getHeading(), true); // 요던입구
			isUseItem = true;
		}
	...
	private boolean useBossTeleportBook(L1PcInstance pc, int itemId, String s) {
		boolean isUseItem = false;

		L1ItemInstance item = pc.getInventory().findItemId(45073);
		if (s.equals("A31")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
			...
			L1Teleport.teleport(pc, 32607, 33028, (short) 0, 2, true); // 커츠
			isUseItem = true;
		} else if (s.equals("B32")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			if (IvoryTowerController.getInstance().isgameStart == true) {
				L1Teleport.teleport(pc, 32711, 32825, (short) 82, 2, true); // 데몬
				isUseItem = true;
			} else {
				pc.sendPackets(new S_SystemMessage("\\fY상아탑8층이 열려있지 않습니다."));
			}
			
		} else if (s.equals("C33")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32670, 32832, (short) 603, 2, true); // 32891 32796 410 타락 - 발록
			isUseItem = true;
		} else if (s.equals("D34")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33342, 32440, (short) 4, 2, true); // 32730 32895 522 혼돈 - 흑장로
			isUseItem = true;
		} else if (s.equals("E35")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33728, 32262, (short) 4, 2, true); // 33728 32262 4 피닉
			isUseItem = true;
		} else if (s.equals("F36")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33334, 32448, (short) 4, 2, true); // 32720 32848 2 바포-드레이크
			isUseItem = true;
		} else if (s.equals("G37")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 34260, 33403, (short) 4, 2, true); // 34242 33359 4 에자

			// 34242, 33359, (short) 4, 2, true)
			isUseItem = true;
		} else if (s.equals("H38")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 33726, 32252, (short) 4, 2, true); // 32757 32855 543 여왕개미-이프리트
			isUseItem = true;
		} else if (s.equals("I39")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			if (GludioDungeonController.getInstance().isgameStart == true) {
				L1Teleport.teleport(pc, 32781, 32810, (short) 13, 2, true); // 32806 32728 812 데스
				isUseItem = true;
			} else {
				pc.sendPackets(new S_SystemMessage("\\fY본던7층이 열려있지 않습니다."));
			}
	...
	private boolean useOmanTeleportBook(L1PcInstance pc, int itemId, String s) {
		boolean isUseItem = false;
		L1ItemInstance item = pc.getInventory().findItemId(52064);
		...
		if (s.equals("A21")) {
			...
			L1Teleport.teleport(pc, 32800, 32800, (short) 120, 2, true);
			isUseItem = true;
		} else if (s.equals("C23")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32800, 32800, (short) 130, 2, true);
			isUseItem = true;
		} else if (s.equals("D24")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
			...
			L1Teleport.teleport(pc, 32800, 32800, (short) 140, 2, true);
			isUseItem = true;
		} else if (s.equals("E25")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32796, 32796, (short) 150, 2, true);
			isUseItem = true;
		} else if (s.equals("F26")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32720, 32821, (short) 160, 2, true);
			isUseItem = true;
		} else if (s.equals("G27")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			}
			L1Teleport.teleport(pc, 32720, 32821, (short) 170, 2, true);
			isUseItem = true;
		} else if (s.equals("H28")) {
			if (pc.getMapId() == 70) {
			...
			L1Teleport.teleport(pc, 32720, 32821, (short) 180, 2, true);
			isUseItem = true;

		} else if (s.equals("I29")) {
			if (pc.getMapId() == 70) {
				pc.sendPackets(new S_Paralysis(S_Paralysis.TYPE_TELEPORT_UNLOCK, false));
				pc.sendPackets(new S_ServerMessage(647));
				return isUseItem;
			...
			L1Teleport.teleport(pc, 32720, 32821, (short) 190, 2, true);
			isUseItem = true;

		} else if (s.equals("J30")) {
			...
			L1Teleport.teleport(pc, 32731, 32852, (short) 200, 2, true);
			isUseItem = true;
	...
	private boolean createNewItem2(L1PcInstance pc, int item_id, int count, int EnchantLevel) {
		...
		if (item != null) {
			...
			pc.sendPackets(new S_ServerMessage(403, item.getLogName())); // %0를손에넣었습니다.
			return true;
		} else {
			return false;
		}
	...
	public static class SearchShopHtmlTimer extends TimerTask {
		private L1PcInstance _pc;
		private L1Character _cha;

		public SearchShopHtmlTimer(L1PcInstance pc, L1Character cha) {
			_pc = pc;
			_cha = cha;
		}
		...
		public void run() {
			...
			while (true) {
				try {
					Thread.sleep(100);
					if (!_pc.isTeleport()) {
						_pc.sendPackets(new S_NPCTalkReturn(_cha.getId(), "usershop"));
						break;
					}
