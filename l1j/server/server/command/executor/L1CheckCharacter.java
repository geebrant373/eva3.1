      ...
      if (type.equalsIgnoreCase("인벤")) {
        try {
          ...
          while (r.next()) {
            ...
            r1 = p1.executeQuery();
            while (r1.next()) {
              itemname = getInvenItemMsg(r1.getInt(1), r1.getInt(2), r1.getInt(3), r1.getInt(4),
        ...
        try {
          ...
          while (r.next()) {
            pc.sendPackets(new S_SystemMessage(
                "\\fW** 검사: " + type + " 캐릭: " + charname + "(" + r.getString(1) + ") **"));
            ...
            r1 = p1.executeQuery();
            while (r1.next()) {
              itemname = getInvenItemMsg(r1.getInt(1), r1.getInt(2), 0, r1.getInt(3),
