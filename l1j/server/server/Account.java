...
public class Account {
	...
	public int dragongludio;
	public int dreamisland;
	public int giranprison;
	public int lastabard;
	public int antdundeon;
	public int shadowtemple;
	/** 메세지 로그용 */
...
//	}
	...
	public static Account create(final String name, final String rawPassword,
		...
		try {
			...
			String sqlstr = "INSERT INTO accounts SET login=?,password=?,lastactive=?,access_level=?,ip=?,host=?,banned=?,charslot=?,gamepassword=?,point_time=?,Point_time_ready=?,keyword=?";
	...
	public static Account load(final String name) {
		...
		try {
			...
			account._keyword = rs.getString("keyword");
			account.dreamisland = (rs.getInt("dreamisland"));
			account.giranprison = (rs.getInt("giranprison"));
			account.dragongludio = (rs.getInt("dragongludio"));
	...
	public void updateKeyword(final Account account) {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET keyword=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setString(1, getKeyword());
...
//		}
	...
	public int getAntDundeonTime() {
		return antdundeon;
	}

	public void setAntDundeonTime(int ra) {
		antdundeon = ra;
	}
	
	public int getShadowTempleTime() {
		return shadowtemple;
	}

	public void setShadowTempleTime(int ra) {
		shadowtemple = ra;
	}
	
	public int getDragonGludioTime() {
		return dragongludio;
	}

	public void setDragonGludioTime(int ra) {
		dragongludio = ra;
	}
	
	public int getDreamIslandTime() {
		return dreamisland;
	}

	public void setDreamIslandTime(int ra) {
		dreamisland = ra;
	}
	   
	public int getGiranPrisonTime() {
		return giranprison;
	}

	public void setLastabardTime(int gi) {
		lastabard = gi;
	}
	...
	public void setGiranPrisonTime(int gi) {
		giranprison = gi;
	}
	...
	public static boolean checkLoginIP(String ip) {  
		...
		try {
			...
			if (num < Config.ipCount) return false;
			else 		 return true;
		}catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
		} finally {
	...
	public void updateDreamIsland() {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET dreamisland=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setInt(1, dreamisland);
			pstm.setString(2, _name);
			pstm.executeUpdate();
		} catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
	...
	public void updateDragonGludio() {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET dragongludio=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setInt(1, dragongludio);
			pstm.setString(2, _name);
			pstm.executeUpdate();
		} catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
	...
	public void updateAntDundeon() {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET antdundeon=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setInt(1, antdundeon);
			pstm.setString(2, _name);
			pstm.executeUpdate();
		} catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
	...
	public void updateShadowTemple() {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET shadowtemple=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setInt(1, shadowtemple);
			pstm.setString(2, _name);
			pstm.executeUpdate();
		} catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
	...
	public void updateGiranPrison() {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET giranprison=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setInt(1, giranprison);
			pstm.setString(2, _name);
			pstm.executeUpdate();
		} catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
	...
	public void updateLastabard() {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			String sqlstr = "UPDATE accounts SET lastabard=? WHERE login = ?";
			pstm = con.prepareStatement(sqlstr);
			pstm.setInt(1, lastabard);
			pstm.setString(2, _name);
			pstm.executeUpdate();
		} catch (Exception e) {
			_log.log(Level.SEVERE, e.getLocalizedMessage(), e);
