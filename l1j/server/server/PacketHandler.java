...
import static l1j.server.server.Opcodes.C_OPCODE_CASH_SHOP;
...
import l1j.server.server.clientpackets.C_InventoryWarehouse;
...
public class PacketHandler {
	...
	public void handlePacket(byte abyte0[], L1PcInstance object) throws Exception {
		...
		case C_OPCODE_BOARDDELETE:
			...
			break;
		case C_OPCODE_CASH_SHOP: //부가아이템 창고
...
//			break;
		...
		case C_OPCODE_RESTART:
			...
			/* new C_NoticeClick(_client); */ break;
