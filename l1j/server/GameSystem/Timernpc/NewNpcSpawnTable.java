...
public class NewNpcSpawnTable {
	private static NewNpcSpawnTable _instance;

	public static NewNpcSpawnTable getInstance() {
		if (_instance == null) {
			_instance = new NewNpcSpawnTable();
		}
		return _instance;
	}

	private static Logger _log = Logger.getLogger(NewNpcSpawnTable.class.getName());
	...
	public static void reload() {
		NewNpcSpawnTable oldInstance = _instance;
		_instance = new NewNpcSpawnTable();
	...
	private NewNpcSpawnTable() {
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		try {
			con = L1DatabaseFactory.getInstance().getConnection();
			pstm = con.prepareStatement("SELECT * FROM spawnlist_timenpc");
