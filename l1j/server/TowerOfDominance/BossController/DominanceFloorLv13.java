...
public class DominanceFloorLv13 implements Runnable {
	...
	public DominanceFloorLv13(int bossid, int x, int y, int mapid, boolean mentuse, String ment, boolean effectuse,
			int effectid) {
		_npcid = bossid;
		_mapx = x;
		_mapy = y;
