...
public class LineageEncryption{
	...
	public char[] decrypt(char ac[], int size){
		//System.out.println("전1 :"+ac[0]+", "+ac[1]+", "+ac[2]+", "+ac[3]+", "+ac[4]+", "+ac[5]);
		_decrypt(ac, size);
		//System.out.println("전2 :"+ac[0]+", "+ac[1]+", "+ac[2]+", "+ac[3]+", "+ac[4]+", "+ac[5]);
		long l = ul32.fromArray(ac);
		//System.out.println("후1 :"+ac[0]+", "+ac[1]+", "+ac[2]+", "+ac[3]+", "+ac[4]+", "+ac[5]);
