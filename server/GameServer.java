...
import l1j.server.server.TimeController.TimePresentController;
...
import l1j.server.server.model.TimePresentscheduler;
...
//		L1BugBearRace.getInstance();
		...
		GeneralThreadPool.getInstance().execute(TimePresentController.getInstance());
